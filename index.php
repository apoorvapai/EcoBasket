...
.content {
  ...
  font-size: 30px;
    ...
    <body>
<div class="icon-bar">
  <a href="bot.php" class="facebook"><i class="fa fa-question-circle"></i></a> 
</div>
...
if (isset($_GET['page_no']) && $_GET['page_no']!="") {
    ...
    $query=mysqli_query($con,"select products.id as pid,products.productImage1,products.productName,products.productPriceBeforeDiscount,products.productPrice from products where category >1 order by pid desc LIMIT $offset, $total_records_per_page ");
$cnt=1;
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="card-footer p-3 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="product-details.php?pid=<?php echo htmlentities($row['pid']);?>">View</a>
   </div>
